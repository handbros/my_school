...
part of 'MealInfoApiResult.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

MealInfoApiResult _$MealInfoApiResultFromJson(Map<String, dynamic> json) {
  return MealInfoApiResult(
    ...
    items: (json['items'] as List)
        ?.map((e) =>
            e == null ? null : MealInfo.fromJson(e as Map<String, dynamic>))
        ?.toList(),
  );
}

Map<String, dynamic> _$MealInfoApiResultToJson(MealInfoApiResult instance) =>
    <String, dynamic>{
