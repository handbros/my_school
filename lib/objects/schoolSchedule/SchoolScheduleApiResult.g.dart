...
part of 'SchoolScheduleApiResult.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

SchoolScheduleApiResult _$SchoolScheduleApiResultFromJson(
    Map<String, dynamic> json) {
  return SchoolScheduleApiResult(
    ...
    (json['items'] as List<dynamic>)
        .map((e) => SchoolSchedule.fromJson(e as Map<String, dynamic>))
        .toList(),
  );
}

Map<String, dynamic> _$SchoolScheduleApiResultToJson(
        SchoolScheduleApiResult instance) =>
    <String, dynamic>{
