...
class _SchoolSchedulePageState extends State<SchoolSchedulePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: schoolScheduleContent(context),
    );
  }

  Widget schoolScheduleContent(BuildContext context) {
    ...
    return FutureBuilder(
      future: SchoolScheduleApi().getApiResult(officeCode, schoolCode, date: date),
      builder: (context, AsyncSnapshot<SchoolScheduleApiResult> snapshot) {
        if (!snapshot.hasData) {
          return SizedBox(
            child: Column(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text("${result.items[index].eventName}")
                      ],
                    ),
                  ),
                ),
